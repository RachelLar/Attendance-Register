...
$query = "INSERT INTO attend (attendance, reason, student_id, slot_id) VALUES ('".$attendance."','".$reason."',".$student_id.",".$slot_id.")";
echo $query;

// execute the query
       $results = mysqli_query($dbc, $query); 
	   
	    if ($attendance && $student_id && $slot_id)  // Then, IF everything is set correctly
