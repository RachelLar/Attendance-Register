...
if ($_SESSION['user_level'] != 2) // If the user is not Managment, redirect to the Login page
    {
...
// set up the SQL query to retrive student ID
$query1 = "SELECT student_id, fname, lname
		  FROM student
		  ORDER BY fname";
...
<html lang="en" xml:lang="en">  
	...
	<body>
		<div id="main"> <!-- ======================== Main Page ========================= -->
			...
			<form name="mainMenu" action="mainMenu.html" method="get">
